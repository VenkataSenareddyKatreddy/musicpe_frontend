...
const CreatePlaylist = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-600 to-orange-200 text-white flex justify-start flex-col p-5 space-y-10 min-h-screen pb-32 ">
      ...
      <div
        ...
        className="bg-green-500 fixed rounded-xl px-2 text-lg  bottom-20 right-5 flex justify-center items-center space-x-1 cursor-pointer"
      >
        <GrFormAdd />
        <span className="text-black">Create Playlist</span>
      </div>
      {/* Create PlayList Card */}
      {cretePlaylist && (
        <div className="bg-gradient-to-r from-orange-300 to-lime-100 fixed top-0 left-0 w-full h-full flex justify-center items-center">
          <div className="bg-white p-10 flex flex-col justify-center items-center space-y-5 rounded-xl relative">
            ...
            <button
              ...
              className="bg-green-500 px-5 py-1 rounded-md lg:rounded-xl shadow-lg text-white text-big "
            >
              Create
            </button>
          </div>
