...
const UploadSong = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen py-10 text-white px-5 bg-gradient-to-r from-gray-700 via-gray-900 to-black space-y-5 pb-10 lg:p-20">
      ...
      >
        ...
        <button
          className="bg-green-500 text-white text-big  py-1 rounded-xl w-100 lg:mx-4"
          type="submit"
