...
import stereo from "../assets/music.jpg";
...
const AudioPlayer = () => {
  ...
  return (
    <div
      className={` fixed flex justify-around lg:justify-center lg:space-x-40 items-center bottom-0 right-0 left-0 bg-gradient-to-t from-indigo-200 via-slate-600 to-indigo-200 text-white px-5 py-2 shadow-xl`}
    >
